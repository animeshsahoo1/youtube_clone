...
const PlayVideo = () => {
    ...
    //fetchvideodata must work first so that we can get the channel id
    useEffect(()=>{
        fetchOtherData();
    },[apiData])
    ...
    return (
        <div className='play-video'>
            ...
            {/*the below line is copied embeed code from any random video on youtube to know its composition */}
            {console.log(videoId)}
            ...
            <div className="video-description">
                ...
                <hr />
                <h4>{apiData?value_converter(apiData.statistics.commentCount):"16k"} comments</h4>
